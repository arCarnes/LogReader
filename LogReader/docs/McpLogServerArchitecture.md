...
- Reproducible headless/live/three-client timing and memory evidence is maintained in [MCP Performance and Mainline Measurements](./McpPerformanceMeasurements.md).
