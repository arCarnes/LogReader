...
- Notes:
  ...
  - 2026-07-11: Implementation commits: `a7575ff` (`Add adaptive indexed sparse search`) and `099131d` (`Harden indexed search snapshot fallback`).
