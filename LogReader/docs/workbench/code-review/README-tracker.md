...
| Not started | Pass 2 | [02-search-tail-memory-bounds.md](02-search-tail-memory-bounds.md) | Unbounded tail filter catch-up; uncapped retained search line text; virtualized search row cache; highlight regex cache |
