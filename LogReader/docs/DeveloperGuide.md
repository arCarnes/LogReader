...
- `LogReader.Mcp` produces `WeezTail.Mcp.exe` and owns the official `ModelContextProtocol.Core` adapter, exact eight-tool registration, stdio lifecycle, and headless backend composition. It must remain free of App and WPF references.
