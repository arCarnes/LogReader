...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 115, 132, 144, 153
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` lines 568, 706, 278-284
...
- **File:** `LogReader.Infrastructure/Repositories/JsonStore.cs` lines 30-36
...
- **File:** `LogReader.Infrastructure/Services/SearchService.cs` line 110
...
- **File:** `LogReader.Infrastructure/Services/SearchService.cs` lines 59, 72-76
...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 49-53
...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 33, 39, 42-46
...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 202-213
...
- **File:** `LogReader.Infrastructure/Services/ChunkedLogReaderService.cs` lines 68, 252-261
...
- **File:** `LogReader.Infrastructure/Services/ChunkedLogReaderService.cs` lines 130, 155
...
- **File:** `LogReader.App/Views/MainWindow.xaml.cs` line 854
...
- **File:** `LogReader.App/Views/MainWindow.xaml.cs` lines 434, 439, 466, 473, 687
...
- **File:** `LogReader.Infrastructure/Repositories/JsonLogGroupRepository.cs` lines 155-164
...
- **Files:** `LogReader.App/ViewModels/LogTabViewModel.cs` lines 156, 500, 545; `LogReader.App/ViewModels/MainViewModel.cs` lines 960, 1638
...
- **File:** `LogReader.App/ViewModels/MainViewModel.cs` lines 292-303
...
- **File:** `LogReader.App/ViewModels/FilterPanelViewModel.cs` lines 48, 87, 113
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` lines 906, 933
...
- **File:** `LogReader.App/ViewModels/MainViewModel.cs` lines 1650-1657
...
- **File:** `LogReader.App/ViewModels/SearchPanelViewModel.cs` lines 487-498
...
- **File:** `LogReader.App/ViewModels/MainViewModel.cs` lines 1184-1214
...
- **File:** `LogReader.Infrastructure/Services/SearchService.cs` line 72
...
- **File:** `LogReader.Infrastructure/Services/SearchService.cs` line 35; `LogReader.App/ViewModels/FilterPanelViewModel.cs` line 98
...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 162-178
...
- **File:** `LogReader.Infrastructure/Services/FileTailService.cs` lines 78-84
...
- **File:** `LogReader.Infrastructure/Services/ChunkedLogReaderService.cs` lines 85, 91-92
...
- **File:** `LogReader.Infrastructure/Services/ChunkedLogReaderService.cs` lines 130, 153
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` line 27
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` lines 488-501
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` line 1148
...
- **File:** `LogReader.App/ViewModels/LogTabViewModel.cs` lines 969-1001
...
- **File:** `LogReader.App/ViewModels/SearchPanelViewModel.cs` lines 286-336
...
- **File:** `LogReader.App/ViewModels/SearchPanelViewModel.cs` lines 338-364
...
- **File:** `LogReader.App/ViewModels/MainViewModel.cs` lines 1609-1639
...
- **File:** `LogReader.Infrastructure/Repositories/JsonLogFileRepository.cs` lines 42-53
...
- **File:** `LogReader.Infrastructure/Repositories/JsonLogGroupRepository.cs` lines 18-48
...
- **File:** `LogReader.Infrastructure/Repositories/JsonStore.cs` lines 38-47
...
- **File:** `LogReader.App/Views/MainWindow.xaml.cs` line 217
...
- **File:** `LogReader.App/App.xaml.cs` line 36
...
- **File:** `LogReader.App/ViewModels/MainViewModel.cs` lines 173-188
